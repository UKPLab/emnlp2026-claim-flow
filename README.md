...
# arxiv2026_claim_flow
[![Arxiv](https://img.shields.io/badge/Arxiv-YYMM.NNNNN-red?style=flat-square&logo=arxiv&logoColor=white)](https://put-here-your-paper.com)
[![License](https://img.shields.io/github/license/UKPLab/arxiv2026-claim-flow)](https://opensource.org/licenses/Apache-2.0)
...
To import classes/methods of `arxiv2026_claim_flow` from inside the package itself you can use relative imports: 
...
```py
from arxiv2026_claim_flow import BaseClass # Notice how I omit the file name
from arxiv2026_claim_flow.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2026_claim_flow` from command line:

```bash
$ python -m arxiv2026_claim_flow
```
